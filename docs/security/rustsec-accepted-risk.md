...
| RUSTSEC-2026-0212 | `libcrux-secrets 0.0.5` | Compiled through `libcrux-sha3`; the defect is AArch64-specific | Accepted only for an amd64 deployment; do not schedule on AArch64 |
